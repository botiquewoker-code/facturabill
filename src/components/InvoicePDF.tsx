  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.leftColumn}>
            ...
            <Text style={styles.companyDetail}>
              {datos.empresa.cp} {datos.empresa.ciudad}
            </Text>
          ...
          <View style={styles.rightColumn}>
            ...
            <Text style={styles.clientDetail}>
              {datos.cliente.cp} {datos.cliente.ciudad}
            </Text>
        ...
        {/* Totales (calcula aquí para evitar cache) */}
        <View style={styles.totalRow}>
          <Text>IVA ({datos.ivaPorc}%)</Text>
          <Text>{datos.iva.toFixed(2)} €</Text>
        </View>
        {datos.retencionPorc > 0 && (
          <View style={styles.totalRow}>
            <Text>Retención ({datos.retencionPorc}%)</Text>
            <Text>-{datos.retencion.toFixed(2)} €</Text>
          </View>
        )}
